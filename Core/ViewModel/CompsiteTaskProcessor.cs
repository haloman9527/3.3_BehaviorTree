...
namespace CZToolKit.BehaviorTree
{
    public abstract class CompositeTaskProcessor : ContainerTaskProcessor
    {
        ...
        protected CompositeTaskProcessor(Task model) : base(model)
        {
            ...
            AddPort(new BasePortProcessor(TaskProcessor.ChildrenPortName, BasePort.Orientation.Vertical, BasePort.Direction.Output, BasePort.Capacity.Multi, typeof(TaskProcessor)));
        }
    }
}